...
<title><?= e($set['site_title'] ?? 'SEBA Crash Bars') ?> — zaštitna oprema za motocikle, Beograd</title>
<meta name="description" content="<?= e($set['meta_description'] ?? '') ?>">
...
<header class="topbar">
  <div class="wrap topbar-inner">
    <a class="brand" href="#top" aria-label="SEBA Crash Bars — početak">
    ...
    <nav id="mainnav" class="nav" aria-label="Glavni meni">
      ...
      <a href="#<?= e($s['id']) ?>"><?= e($navNames[$s['type']]) ?></a>
      <?php endforeach; ?>
